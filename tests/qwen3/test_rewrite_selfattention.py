"""Auto-generated: validates rewrite of SelfAttention."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'SelfAttention'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/qwen3_einsum.py')
_CLASS_NAME = 'SelfAttention'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_selfattention", _REWRITTEN_SRC)
...
def test_selfattention_rewrite_matches_original():
