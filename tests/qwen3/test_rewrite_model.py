"""Auto-generated: validates rewrite of Model."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'Model'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/qwen3_einsum.py')
_CLASS_NAME = 'Model'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_model", _REWRITTEN_SRC)
...
def test_model_rewrite_matches_original():
