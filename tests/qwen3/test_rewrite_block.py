"""Auto-generated: validates rewrite of Block."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'Block'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/qwen3_einsum.py')
_CLASS_NAME = 'Block'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_block", _REWRITTEN_SRC)
...
def test_block_rewrite_matches_original():
