"""Auto-generated: validates rewrite of DenseMLP."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'DenseMLP'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/qwen3_einsum.py')
_CLASS_NAME = 'DenseMLP'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_densemlp", _REWRITTEN_SRC)
...
def test_densemlp_rewrite_matches_original():
