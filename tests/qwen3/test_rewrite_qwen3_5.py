"""Auto-generated: validates rewrite of Qwen3_5."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'Qwen3_5'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/qwen3_einsum.py')
_CLASS_NAME = 'Qwen3_5'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_qwen3_5", _REWRITTEN_SRC)
...
def test_qwen3_5_rewrite_matches_original():
