"""Auto-generated: validates rewrite of MLP."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'MLP'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/model_einsum.py')
_CLASS_NAME = 'MLP'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_mlp", _REWRITTEN_SRC)
...
def test_mlp_rewrite_matches_original():
