"""Auto-generated: validates rewrite of EncoderBlock."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'EncoderBlock'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/llama_einsum.py')
_CLASS_NAME = 'EncoderBlock'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_encoderblock", _REWRITTEN_SRC)
...
def test_encoderblock_rewrite_matches_original():
