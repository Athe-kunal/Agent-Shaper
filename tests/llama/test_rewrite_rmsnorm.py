"""Auto-generated: validates rewrite of RMSNorm."""
...
_FIXTURE_DIR = Path(__file__).parent / "fixtures" / 'RMSNorm'
_REWRITTEN_SRC = Path('/Users/athekunal/DEV/Agent-Shaper/agent_shaper/transformer/llama_einsum.py')
_CLASS_NAME = 'RMSNorm'


def _load_rewritten_class():
    spec = importlib.util.spec_from_file_location("_rewritten_rmsnorm", _REWRITTEN_SRC)
...
def test_rmsnorm_rewrite_matches_original():
